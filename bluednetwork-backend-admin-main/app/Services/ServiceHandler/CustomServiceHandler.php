 ...
 */
class CustomServiceHandler extends Services
{

    public function getName(): string
    {
        return $this->serviceObject->title ?? "";
    }

    public function getDescription(): string
    {
        return $this->serviceObject->description ?? "";
    }
    ...
    public function execute(Request $data)
    {
        ...
        if ($processOtherData) {
            DB::beginTransaction();
            try {
                $order = $this->saveOrder($variant, $amount, $orderItems, $modeOfPayment,
                    ($data['custom_fields'] ?? []));
